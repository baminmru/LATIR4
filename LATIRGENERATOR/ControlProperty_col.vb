...
<System.Runtime.InteropServices.ProgId("ControlProperty_col_NET.ControlProperty_col")> Public Class ControlProperty_col
	...
	Public Function Add(Optional ByRef ID As String = "") As ControlProperty
		Dim o As ControlProperty
		o = New ControlProperty
	...
	Public Function Item(ByVal ID As Object) As ControlProperty
	...
	Friend Sub Remove(ByVal vntIndexKey As Object)
    ...
    Public Sub XMLSave(ByRef ParentNode As System.Xml.XmlElement, ByRef xdom As System.XML.xmlDocument)
        ...
        For i = 1 To Count
            o = Item(i)
            node = xdom.createElement("ControlProperty")
