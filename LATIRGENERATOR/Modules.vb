...
<System.Runtime.InteropServices.ProgId("Modules_NET.Modules")> Public Class Modules
	...
	'Parameters:
	'[IN]   ModuleName , тип параметра: String  - ...
	'Returns:
	'  объект класса ModuleHolder
	'  ,или Nothing
	'See Also:
	'  Count
	'  Item
	...
	'  XMLSave
	'Example:
	' dim variable as ModuleHolder
	' Set variable = me.Add(<параметры>)
	Public Function Add(ByVal ModuleName As String) As ModuleHolder
		'create a new object
		Dim objNewMember As ModuleHolder
		objNewMember = New ModuleHolder
		
		
		objNewMember.ModuleName = ModuleName
		mcol.Add(objNewMember, ModuleName)
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As ModuleHolder
		Get
    ...
    Public Sub XMLSave(ByRef ParentNode As System.Xml.XmlElement, ByRef xdom As System.XML.xmlDocument)
        Dim o As ModuleHolder
        Dim i As Integer
        Dim node As System.Xml.XmlElement
        For i = 1 To Count
            o = Item(i)
            node = xdom.createElement("ModuleHolder")
    ...
    Public Sub XMLLoad(ByRef NodeList As System.Xml.XmlNodeList)
        ...
        For i = 0 To NodeList.Count - 1
            ...
            If Item((node.Attributes.GetNamedItem("ModuleName").Value)) Is Nothing Then
                'UPGRADE_WARNING: Couldn't resolve default property of object node. Click for more: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
                Add(node.Attributes.GetNamedItem("ModuleName").Value).XMLLoad(node)
            Else
                'UPGRADE_WARNING: Couldn't resolve default property of object node. Click for more: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
                Item((node.Attributes.GetNamedItem("ModuleName").Value)).XMLLoad(node)
            End If
        Next
    End Sub
End Class