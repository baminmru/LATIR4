...
<System.Runtime.InteropServices.ProgId("PropertyData_col_NET.PropertyData_col")> Public Class PropertyData_col
	...
	Friend ReadOnly Property ChildStructID() As String
		Get
			Return "{02580C29-2F95-4655-9BAB-70F994B13DCD}"
		End Get
	End Property
	...
	Public Function Add(Optional ByRef ID As String = "") As PropertyData
	...
	Public Function Item(ByVal ID As Object) As PropertyData
    ...
    Public Sub XMLSave(ByRef ParentNode As System.Xml.XmlElement, ByRef xdom As System.XML.xmlDocument)
        ...
        For i = 1 To Count
            o = Item(i)
            node = xdom.createElement("PropertyData")
