...
<System.Runtime.InteropServices.ProgId("Blocks_NET.Blocks")> Public Class Blocks
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As BlockHolder
		Get
    ...
    Public Sub XMLSave(ByRef ParentNode As System.Xml.XmlElement, ByRef xdom As System.XML.XmlDocument)
        ...
        For i = 1 To Count
            o = Item(i)
            node = xdom.createElement("BlockHolder")
    ...
    Public Sub XMLLoad(ByRef NodeList As System.Xml.XmlNodeList)
        ...
        For i = 0 To NodeList.Count - 1
            ...
            If Item((node.Attributes.GetNamedItem("BlockName").Value)) Is Nothing Then
                ...
                Add(node.Attributes.GetNamedItem("BlockName").Value).XMLLoad(node)
            Else

                Item((node.Attributes.GetNamedItem("BlockName").Value)).XMLLoad(node)
            End If
