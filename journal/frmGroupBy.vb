...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents cboExpandCollapse As System.Windows.Forms.ComboBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cboExpandCollapse = New System.Windows.Forms.ComboBox()
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(14, 86)
        ...
        Me.btnOK.Location = New System.Drawing.Point(332, 16)
        Me.btnOK.Name = "btnOK"
        ...
        Me.btnCancel.Location = New System.Drawing.Point(332, 48)
        ...
        Me.btnClear.Location = New System.Drawing.Point(332, 76)
        ...
        Me.Label1.Location = New System.Drawing.Point(28, 308)
        Me.Label1.Name = "Label1"
        Me.Label1.Size = New System.Drawing.Size(93, 13)
        Me.Label1.TabIndex = 7
        Me.Label1.Text = "Expand/Collapse:"
        '
        'cboExpandCollapse
        '
        Me.cboExpandCollapse.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
        Me.cboExpandCollapse.Location = New System.Drawing.Point(132, 308)
        Me.cboExpandCollapse.Name = "cboExpandCollapse"
        Me.cboExpandCollapse.Size = New System.Drawing.Size(192, 21)
        Me.cboExpandCollapse.TabIndex = 8
        '
        'frmGroupBy
        '
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.cboExpandCollapse, Me.Label1, Me.btnClear, Me.btnCancel, Me.btnOK, Me.GroupBox4, Me.GroupBox3, Me.GroupBox2, Me.GroupBox1})
...
#End Region
    ...
    Public Overloads Function ShowDialog(ByVal grid As GridEX, ByVal parent As Form) As DialogResult
        ...
        Me.cboExpandCollapse.Items.Add("All Expanded")
        Me.cboExpandCollapse.Items.Add("All Collapsed")
        If grid.GroupMode = GroupMode.Collapsed Then
            cboExpandCollapse.SelectedIndex = 1
        Else
            cboExpandCollapse.SelectedIndex = 0
        End If
        With grid.RootTable.Groups
            If .Count = 0 Then
                SetGroup(Nothing, True, cboColumn0, optAscending0, optDescending0)
            Else
                If .Count >= 1 Then
                    group = .Item(0)
                    SetGroup(group.Column, (group.SortOrder = SortOrder.Ascending), cboColumn0, optAscending0, optDescending0)
                End If
                If .Count >= 2 Then
                    group = .Item(1)
                    SetGroup(group.Column, (group.SortOrder = SortOrder.Ascending), cboColumn1, optAscending1, optDescending1)
                End If
                If .Count >= 3 Then
                    group = .Item(2)
                    SetGroup(group.Column, (group.SortOrder = SortOrder.Ascending), cboColumn2, optAscending2, optDescending2)
                End If
                If .Count >= 4 Then
                    group = .Item(3)
                    SetGroup(group.Column, (group.SortOrder = SortOrder.Ascending), cboColumn3, optAscending3, optDescending3)
                End If
            End If
        End With
    ...
    End Function
    Private Sub CreateGroups(ByVal grid As GridEX)
        Dim groupsCount As Integer
        ...
        Else
            groupsCount = 0
        End If
        Dim groups(groupsCount - 1) As GridEXGroup
        If groupsCount > 0 Then
            groups(0) = CreateGroup(CType(cboColumn0.SelectedItem, NamedObject).Value, optAscending0.Checked)
        End If
        If groupsCount > 1 Then
            groups(1) = CreateGroup(CType(cboColumn1.SelectedItem, NamedObject).Value, optAscending1.Checked)
        End If
        If groupsCount > 2 Then
            groups(2) = CreateGroup(CType(cboColumn2.SelectedItem, NamedObject).Value, optAscending2.Checked)
        End If
        If groupsCount > 3 Then
            groups(3) = CreateGroup(CType(cboColumn3.SelectedItem, NamedObject).Value, optAscending3.Checked)
        End If
        If cboExpandCollapse.SelectedIndex = 0 Then
    ...
    End Sub
    Private Function CreateGroup(ByVal column As GridEXColumn, ByVal ascending As Boolean) As GridEXGroup
        Dim group As GridEXGroup = New GridEXGroup()
        group.Column = column
        If Not ascending Then
            group.SortOrder = SortOrder.Descending
        End If
        Return group
    End Function
    Private Sub FillColumnList(ByVal columns As GridEXColumnCollection, ByVal combo As ComboBox)
        ...
        For i = 0 To columns.Count - 1
            ...
            If column.AllowGroup Then
                combo.Items.Add(New NamedObject(column, column.Caption))
            End If
        Next
    End Sub
    Private Sub SetGroup(ByVal column As GridEXColumn, ByVal ascending As Boolean, ByVal combo As ComboBox, ByVal optAscending As RadioButton, ByVal optDescending As RadioButton)
