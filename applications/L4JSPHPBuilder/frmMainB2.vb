...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.MenuItem9.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem15, Me.mnuMakeExtJSMy, Me.mnuAddUnique, Me.mnuCompress})
        ...
        Me.Name = "frmMainB2"
        Me.Text = "Генератор JS+PHP для Ext JS 5"
...
#End Region
    ...
    Private Sub frmMDI_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.Text = "Генератор JS+PHP для Ext JS 5" & " :: " & sitename
        Timer2.Enabled = True
    End Sub
