...
#Region "Windows Form Designer generated code "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		Me.Text = "Объединение и удаление строк раздла"
		...
		Me.Label3.Text = "Раздел для выбора строки"
		...
		Me.Label2.Text = "Заменяющая строка"
		...
		Me.Label1.Text = "Строка, которую надо заменить (и удалить)"
