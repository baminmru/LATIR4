...
Module Utils
    ...
    '           Else
    '               'UPGRADE_WARNING: Couldn't resolve default property of object om.FIELDRESTRICTION.Item(i).ThePart.ID. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
    '               Dim FIELDRESTRICTION As MTZMetaModel.MTZMetaModel.FIELDRESTRICTION = om.FIELDRESTRICTION.Item(i)
    '               If FIELDRESTRICTION.ThePart.ID.ToString() = s.ID.ToString() Then
    '                   'UPGRADE_WARNING: Couldn't resolve default property of object om.FIELDRESTRICTION.Item(i).TheField.ID. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
    '                   If FIELDRESTRICTION.TheField.ID.ToString() = FieldID Then
    '                       If om.FIELDRESTRICTION.Item(i).AllowRead Then
    '                           OK = True
    '                       Else
    '                           OK = False
    ...
    '        If LATIRFramework.ObjectHelper.CountStructs(prev.PART, mode) > 1 Then
    '            AnalizeInterface = "common"
    '            Exit Function
    '        End If

    '        If LATIRFramework.ObjectHelper.CountStructs(s.PART, mode) > 0 Then
    '            AnalizeInterface = "common"
    '            Exit Function
    '        End If
    ...
    '        If LATIRFramework.ObjectHelper.CountStructs(s.PART, mode) > 1 Then
    '            AnalizeInterface = "common"
    '            Exit Function
    '        End If
    ...
    '            If LATIRFramework.ObjectHelper.IsPresent(s.PART.Item(i), mode) Then
    '                If LATIRFramework.ObjectHelper.CountStructs(s.PART.Item(1).PART, mode) > 0 Then
    '                    AnalizeInterface = "common"
    '                    Exit Function
    '                End If
    '            End If
    ...
    '        Dim i As Integer
    '        Dim s As Object = "String"
    '        Dim tidID As Guid = New Guid(tid)
    ...
    '            If (ft.FIELDTYPEMAP.Item(i).Target.ID.Equals(tidID)) Then
