...
Friend Class frmDocList
    ...
    'UPGRADE_WARNING: Form event frmDocList.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
    Private Sub frmDocList_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        lstJournal.Items.Clear()
        OK = False
        Dim i As Integer
        For i = 1 To model.ObjectType.Count
            If model.OBJECTTYPE.Item(i).IsSingleInstance = MTZMetaModel.MTZMetaModel.enumBoolean.Boolean_Net Then
        ...
        End If
        Call frmDocList_Resize(Me, New System.EventArgs())
    End Sub
	
	'UPGRADE_WARNING: Event frmDocList.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmDocList_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
