...
bye: 
	...
	Private Sub SaveFTypeXML()
        ...
        fn = txtPath.Text & "FIELDTYPE.xml"

        xdom = New System.Xml.XmlDocument
        xdom.LoadXml("<root><APPLICATION></APPLICATION></root>")

        'UPGRADE_WARNING: Couldn't resolve default property of object xdom. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object xdom.lastChild.firstChild. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
