...
Module MakeApp
    ...
    Public Sub MakeApps(ByRef tid As String, ByRef m As MTZMetaModel.MTZMetaModel.Application, ByRef ot As MTZMetaModel.MTZMetaModel.OBJECTTYPE, ByRef o As LATIRGenerator.Response)
        ...
        s = s & vbCrLf & "    Inherits LATIR2GuiManager.Doc_GUIBase"
        ...
        s = s & vbCrLf & "    Public Overrides Function ShowPartEditForm(ByVal Mode As String, ByRef RowItem As LATIR2.Document.DocRow_Base, optional byval FormReadOnly as boolean = false) As Boolean"
        s = s & vbCrLf & "        ' Mode"
        ...
        s = s & vbCrLf & "    Public Overrides Function ShowForm(ByVal Mode As String, ByRef DocItem As LATIR2.Document.Doc_Base, optional byval FormReadOnly as boolean = false) As Boolean"
    ...
    Private Sub MakeTabView(ByRef tid As String, ByRef m As MTZMetaModel.MTZMetaModel.Application, ByRef ot As MTZMetaModel.MTZMetaModel.OBJECTTYPE, ByRef o As LATIRGenerator.Response, ByVal mode As String)
        ...
        For i = 1 To ot.PART.Count
            If LATIR2Framework.ObjectHelper.IsPresent(ot.PART.Item(i), mode) Then
                s = s & vbCrLf & "    Friend WithEvents TabPage" & i & " As System.Windows.Forms.TabPage"

                s = s & vbCrLf & "    Friend WithEvents View" & ot.PART.Item(i).Name & " As " & ot.Name & "GUI.view" & ot.PART.Item(i).Name & mode
            End If
        Next
        s = s & vbCrLf & "   "
        ...
        s = s & vbCrLf & "        Me.tab.Dock = System.Windows.Forms.DockStyle.Fill"
        ...
        For i = 1 To ot.PART.Count
            If LATIR2Framework.ObjectHelper.IsPresent(ot.PART.Item(i), mode) Then
                ...
                s = s & vbCrLf & "        Me.TabPage" & i & ".Location = New System.Drawing.Point(-10000, -10000)"
                ...
                s = s & vbCrLf & "        Me.TabPage" & i & ".AutoScroll = True"
                's = s & vbCrLf & "        Me.TabPage" & i & ".Text = """ & ot.PART.Item(i).Caption & """"

                s = s & vbCrLf & "        '"
                s = s & vbCrLf & "        'View" & ot.PART.Item(i).Name & ""
                s = s & vbCrLf & "        '"
                s = s & vbCrLf & "        Me.View" & ot.PART.Item(i).Name & ".Dock = System.Windows.Forms.DockStyle.Fill"
                s = s & vbCrLf & "        Me.View" & ot.PART.Item(i).Name & ".Location = New System.Drawing.Point(0, 0)"
        ...
        '  s = s & vbCrLf & "        CType(Me.tab, System.ComponentModel.ISupportInitialize).EndInit()"
        ...
        s = s & vbCrLf & "    Public Sub Attach(ByVal docItem As LATIR2.Document.Doc_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, byval DocReadOnly as boolean  ) Implements LATIR2GUIManager.IViewPanel.Attach"
    ...
    Private Sub MakeMainForm(ByRef tid As String, ByRef m As MTZMetaModel.MTZMetaModel.Application, ByRef ot As MTZMetaModel.MTZMetaModel.OBJECTTYPE, ByRef o As LATIRGenerator.Response, ByVal mode As String)
        ...
        s = s & vbCrLf & ""
        s = s & vbCrLf & "  Public Class frm" & ot.Name & mode
        ...
        s = s & vbCrLf & "    Dim iv As LATIR2GUIManager.IViewPanel"
        s = s & vbCrLf & "    iv = CType(tv, LATIR2GUIManager.IViewPanel)"
