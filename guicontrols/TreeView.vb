...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        ButtonsTree.AllowExport = False
        ButtonsTree.AllowPrint = False
        ButtonsTree.AllowFind = False
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.tv.Scrollable = Infragistics.Win.UltraWinTree.Scrollbar.Show
...
#Region "Events"
    Public Event OnTreeBeforeExpand(ByVal sender As Object, ByVal Node As Object, ByRef UseDefault As Boolean)
    Public Event OnTreeAfterSelect(ByVal sender As Object, ByVal Node As Object, ByRef UseDefault As Boolean)
#End Region

#Region "Declarations"
    Private mAllowToolBar As Boolean
    Private mAllowMenu As Boolean
...
#Region "Public Functions Properties"
    Public ReadOnly Property TreeView() As UltraTree
        Get
            Return tv
        End Get
    End Property
    ...
    Public Property AllowMenu() As Boolean
        Get
            Return mAllowMenu
        End Get
        Set(ByVal Value As Boolean)
    ...
    Public ReadOnly Property SelectedNode() As UltraTreeNode
        Get
            Return tv.ActiveNode
        End Get
    End Property
...
#Region "Tree View events"
    'Private Sub tv_BeforeExpand(ByVal sender As Object, ByVal ID As System.Guid)
    '    Dim UseDefault As Boolean
    '    UseDefault = True
    '    RaiseEvent OnTreeBeforeExpand(sender, ID, UseDefault)
    '    If (UseDefault) Then
    '        BeforeExpand(sender, FindNode(tv.Nodes, ID))
    '    End If
    'End Sub

    'Private Sub tv_AfterSelect(ByVal sender As Object, ByVal ID As System.Guid)
    '    Dim UseDefault As Boolean
    '    UseDefault = True
    '    RaiseEvent OnTreeAfterSelect(sender, ID, UseDefault)
    '    If (UseDefault) Then
    '        TreeSelect(ID)
    '    End If
    'End Sub

    Private Sub tv_AfterSelect(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinTree.SelectEventArgs) Handles tv.AfterSelect
        Dim UseDefault As Boolean
        UseDefault = True
        Try
            RaiseEvent OnTreeAfterSelect(sender, e.NewSelections.Item(0), UseDefault)
            If (UseDefault) Then
                TreeSelect(e.NewSelections.Item(0))
            End If
        Catch
        End Try
    End Sub

    Private Sub tv_BeforeExpand(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinTree.CancelableNodeEventArgs) Handles tv.BeforeExpand
        Dim UseDefault As Boolean
        UseDefault = True
        Try
            RaiseEvent OnTreeBeforeExpand(sender, e.TreeNode, UseDefault)
            If (UseDefault) Then
                BeforeExpand(sender, e.TreeNode)
            End If
        Catch
        End Try
    End Sub
...
#Region "Find Functions"
    Public Overloads Function FindNode(ByVal root As UltraWinTree.TreeNodesCollection, ByVal ID As System.Guid) As UltraTreeNode
...
#End Region
    ...
    Private Sub ButtonsTree_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonsTree.Load
