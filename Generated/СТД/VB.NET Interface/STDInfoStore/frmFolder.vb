...
''' <summary>
'''Форма редактирования раздела Папка режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditFolder As STDInfoStoreGUI.editFolder
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditFolder = New STDInfoStoreGUI.EditFolder
        ...
        'EditFolder
        '
        Me.EditFolder.AutoScroll = True
        Me.EditFolder.Location = New System.Drawing.Point(8, 8)
        Me.EditFolder.name = "EditFolder"
        Me.EditFolder.Size = New System.Drawing.Size(490, 600)
        Me.EditFolder.TabIndex = 20
        Me.EditFolder.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmFolder
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditFolder)
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, optional byval FormReadOnly as boolean =false)
        Item = CType(RowItem, STDInfoStore.STDInfoStore.Folder)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditFolder.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditFolder_Changed() Handles EditFolder.Changed
...
''' </remarks>
    ...
    Private Sub frmUsers_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditFolder.GetMaxX() + 10, EditFolder.GetMaxY() + 35)
    End Sub
End Class
