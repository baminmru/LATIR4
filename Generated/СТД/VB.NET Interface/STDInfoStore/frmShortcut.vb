...
''' <summary>
'''Форма редактирования раздела Документы режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditShortcut As STDInfoStoreGUI.editShortcut
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditShortcut = New STDInfoStoreGUI.EditShortcut
        ...
        'EditShortcut
        '
        Me.EditShortcut.AutoScroll = True
        Me.EditShortcut.Location = New System.Drawing.Point(8, 8)
        Me.EditShortcut.name = "EditShortcut"
        Me.EditShortcut.Size = New System.Drawing.Size(490, 600)
        Me.EditShortcut.TabIndex = 20
        Me.EditShortcut.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmShortcut
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditShortcut)
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, optional byval FormReadOnly as boolean =false)
        Item = CType(RowItem, STDInfoStore.STDInfoStore.Shortcut)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditShortcut.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditShortcut_Changed() Handles EditShortcut.Changed
...
''' </remarks>
    ...
    Private Sub frmUsers_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditShortcut.GetMaxX() + 10, EditShortcut.GetMaxY() + 35)
    End Sub
End Class
