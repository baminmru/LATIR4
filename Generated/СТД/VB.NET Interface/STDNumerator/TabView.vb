...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents ViewNum_head As STDNumeratorGUI.viewNum_head
    Friend WithEvents TabPage2 As System.Windows.Forms.TabPage
    Friend WithEvents ViewNum_zones As STDNumeratorGUI.viewNum_zones
   
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.tab = New System.Windows.Forms.TabControl
   TabPage1 = New System.Windows.Forms.TabPage
   ViewNum_head = new viewNum_head
   TabPage2 = New System.Windows.Forms.TabPage
   ViewNum_zones = new viewNum_zones
   ...
   Me.TabPage2.SuspendLayout()
        ...
        'TabPage1
        '
        Me.TabPage1.Controls.Add (Me.ViewNum_head)
        ...
        'ViewNum_head
        '
        Me.ViewNum_head.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ViewNum_head.Location = New System.Drawing.Point(0, 0)
        Me.ViewNum_head.name = "ViewNum_head"
        Me.ViewNum_head.Size = New System.Drawing.Size(504, 352)
        Me.ViewNum_head.TabIndex = 0
        '
        'TabPage2
        '
        Me.TabPage2.Controls.Add (Me.ViewNum_zones)
        Me.TabPage2.Location = New System.Drawing.Point(-10000, -10000)
        Me.TabPage2.name = "TabPage2"
        Me.TabPage2.Text = "Зоны"
        ...
        'ViewNum_zones
        '
        Me.ViewNum_zones.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ViewNum_zones.Location = New System.Drawing.Point(0, 0)
        Me.ViewNum_zones.name = "ViewNum_zones"
        Me.ViewNum_zones.Size = New System.Drawing.Size(504, 352)
        Me.ViewNum_zones.TabIndex = 0
...
''' </remarks>
    Public Sub Attach(ByVal docItem As LATIR2.Document.Doc_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, byval DocReadOnly as boolean  ) Implements LATIR2GUIManager.IViewPanel.Attach
        ...
        GuiManager = gm
        ViewNum_head.Attach(item, GuiManager,DocReadOnly)
        ViewNum_zones.Attach(item, GuiManager,DocReadOnly)
    End Sub
...
''' </remarks>
    ...
    Dim ok As Boolean
    ok = True
        ok = ok And ViewNum_head.Save(Sielent, NoError)
        ok = ok And ViewNum_zones.Save(Sielent, NoError)
       Return ok
    End function
...
''' </remarks>
    ...
    Dim ok As Boolean
    ok = True
        ok = ok And ViewNum_head.IsOK()
        ok = ok And ViewNum_zones.IsOK()
       Return ok
    End function
...
''' </remarks>
    ...
    ok = False
        ok = ok or ViewNum_head.IsChanged()
        ok = ok or ViewNum_zones.IsChanged()
       Return ok
    End function
