...
''' <summary>
'''Форма редактирования раздела Доступные действия режим:full
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmROLES_OPERATIONSfull
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditROLES_OPERATIONS As ROLESGUI.editROLES_OPERATIONSfull
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditROLES_OPERATIONS = New ROLESGUI.EditROLES_OPERATIONSfull
        ...
        '
        'EditROLES_OPERATIONS
        '
        Me.EditROLES_OPERATIONS.AutoScroll = True
        Me.EditROLES_OPERATIONS.Location = New System.Drawing.Point(8, 8)
        Me.EditROLES_OPERATIONS.name = "EditROLES_OPERATIONS"
        Me.EditROLES_OPERATIONS.Size = New System.Drawing.Size(490, 600)
        Me.EditROLES_OPERATIONS.TabIndex = 20
        Me.EditROLES_OPERATIONS.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmROLES_OPERATIONS
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditROLES_OPERATIONS)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmROLES_OPERATIONS"
        Me.Text = "Доступные действия"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, ROLES.ROLES.ROLES_OPERATIONS)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditROLES_OPERATIONS.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditROLES_OPERATIONS_Changed() Handles EditROLES_OPERATIONS.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditROLES_OPERATIONS.IsOK() Then
          EditROLES_OPERATIONS.Save()
         Try
          Item.Save()
    ...
    Private Sub frmUsers_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditROLES_OPERATIONS.GetMaxX() + 10, EditROLES_OPERATIONS.GetMaxY() + 35)
