...
Public Class viewROLES_REPORTSfull
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.gv.TabIndex = 0
        '
        'viewROLES_REPORTSfull
        '
        Me.Controls.Add (Me.gv)
        Me.name = "viewROLES_REPORTSfull"
...
''' </remarks>
    Public Sub Init()
        ...
        Dim dt As DataTable
        dt = item.ROLES_REPORTS.GetDataTable()
        dt.TableName = "ROLES_REPORTS"

        ts = New DataGridTableStyle
        ts.MappingName = "ROLES_REPORTS"
        ts.ReadOnly = True
...
''' </remarks>
    Private Sub gv_OnEdit(ByRef OK As Boolean, ByVal ID As System.Guid) Handles gv.OnGridEdit
        Dim ed As ROLES.ROLES.ROLES_REPORTS
        ed = item.FindRowObject("ROLES_REPORTS", ID)
    ...
    Private Sub gv_OnAdd(ByRef OK As Boolean, ByVal ID As System.Guid) Handles gv.OnGridAdd
      If not mReadOnly Then
        ...
        If ID.Equals(System.guid.Empty) Then
              ed = Item.ROLES_REPORTS.Add
          Else
              ed = Item.ROLES_REPORTS.Add(ID.ToString())
          End If
        Dim gui As Doc_GUIBase
        Dim dt As DataTable
        gui = GuiManager.GetTypeGUI(ed.Application.TypeName)
