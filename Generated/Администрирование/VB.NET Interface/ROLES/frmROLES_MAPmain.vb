...
''' <summary>
'''Форма редактирования раздела Отображение на группы режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmROLES_MAPmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditROLES_MAP As ROLESGUI.editROLES_MAPmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditROLES_MAP = New ROLESGUI.EditROLES_MAPmain
        ...
        'EditROLES_MAP
        '
        Me.EditROLES_MAP.AutoScroll = True
        Me.EditROLES_MAP.Location = New System.Drawing.Point(8, 8)
        Me.EditROLES_MAP.name = "EditROLES_MAP"
        Me.EditROLES_MAP.Size = New System.Drawing.Size(490, 600)
        Me.EditROLES_MAP.TabIndex = 20
        Me.EditROLES_MAP.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmROLES_MAP
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditROLES_MAP)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmROLES_MAP"
        Me.Text = "Отображение на группы"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, ROLES.ROLES.ROLES_MAP)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditROLES_MAP.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditROLES_MAP_Changed() Handles EditROLES_MAP.Changed
...
''' </remarks>
    ...
    Private Sub frmUsers_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditROLES_MAP.GetMaxX() + 10, EditROLES_MAP.GetMaxY() + 35)
