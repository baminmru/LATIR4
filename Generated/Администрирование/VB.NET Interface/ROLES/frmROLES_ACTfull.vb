...
''' <summary>
'''Форма редактирования раздела Разрешенные пункты меню режим:full
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmROLES_ACTfull
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditROLES_ACT As ROLESGUI.editROLES_ACTfull
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditROLES_ACT = New ROLESGUI.EditROLES_ACTfull
