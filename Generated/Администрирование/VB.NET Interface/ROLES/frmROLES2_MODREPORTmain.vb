...
''' <summary>
'''Форма редактирования раздела Действия и отчеты режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmROLES2_MODREPORTmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditROLES2_MODREPORT As ROLESGUI.editROLES2_MODREPORTmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditROLES2_MODREPORT = New ROLESGUI.EditROLES2_MODREPORTmain
        ...
        '
        'EditROLES2_MODREPORT
        '
        Me.EditROLES2_MODREPORT.AutoScroll = True
        Me.EditROLES2_MODREPORT.Location = New System.Drawing.Point(8, 8)
        Me.EditROLES2_MODREPORT.name = "EditROLES2_MODREPORT"
        Me.EditROLES2_MODREPORT.Size = New System.Drawing.Size(490, 600)
        Me.EditROLES2_MODREPORT.TabIndex = 20
        Me.EditROLES2_MODREPORT.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmROLES2_MODREPORT
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditROLES2_MODREPORT)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmROLES2_MODREPORT"
        Me.Text = "Действия и отчеты"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, ROLES.ROLES.ROLES2_MODREPORT)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditROLES2_MODREPORT.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditROLES2_MODREPORT_Changed() Handles EditROLES2_MODREPORT.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditROLES2_MODREPORT.IsOK() Then
          EditROLES2_MODREPORT.Save()
         Try
          Item.Save()
    ...
    Private Sub frmUsers_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditROLES2_MODREPORT.GetMaxX() + 10, EditROLES2_MODREPORT.GetMaxY() + 35)
