...
''' <summary>
'''Форма редактирования раздела Журнал событий режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmSysLog
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditSysLog As MTZSystemGUI.editSysLog
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditSysLog = New MTZSystemGUI.EditSysLog
        ...
        'EditSysLog
        '
        Me.EditSysLog.AutoScroll = True
        Me.EditSysLog.Location = New System.Drawing.Point(8, 8)
        Me.EditSysLog.name = "EditSysLog"
        Me.EditSysLog.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditSysLog.TabIndex = 20
        Me.EditSysLog.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmSysLog
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditSysLog)
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZSystem.MTZSystem.SysLog)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditSysLog.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditSysLog_Changed() Handles EditSysLog.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditSysLog.GetMaxX() + 10, EditSysLog.GetMaxY() + 35)
