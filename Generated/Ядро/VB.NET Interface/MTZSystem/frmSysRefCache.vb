...
''' <summary>
'''Форма редактирования раздела Разрешенные владельцы режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmSysRefCache
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditSysRefCache As MTZSystemGUI.editSysRefCache
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditSysRefCache = New MTZSystemGUI.EditSysRefCache
        ...
        Me.Controls.Add (EditSysRefCache)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmSysRefCache"
        Me.Text = "Разрешенные владельцы"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        ...
        EditSysRefCache.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub
