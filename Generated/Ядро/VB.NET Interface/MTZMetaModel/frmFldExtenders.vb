...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditFldExtenders As MTZMetaModelGUI.editFldExtenders
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditFldExtenders = New MTZMetaModelGUI.EditFldExtenders
        ...
        'EditFldExtenders
        '
        Me.EditFldExtenders.AutoScroll = True
        Me.EditFldExtenders.Location = New System.Drawing.Point(8, 8)
        Me.EditFldExtenders.name = "EditFldExtenders"
        Me.EditFldExtenders.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditFldExtenders.TabIndex = 20
        Me.EditFldExtenders.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmFldExtenders
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditFldExtenders)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmFldExtenders"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.FldExtenders)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditFldExtenders.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditFldExtenders_Changed() Handles EditFldExtenders.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditFldExtenders.IsOK() Then
          EditFldExtenders.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditFldExtenders.GetMaxX() + 10, EditFldExtenders.GetMaxY() + 35)
