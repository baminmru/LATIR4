...
''' <summary>
'''Форма редактирования раздела Зачения режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmENUMITEM
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditENUMITEM As MTZMetaModelGUI.editENUMITEM
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditENUMITEM = New MTZMetaModelGUI.EditENUMITEM
        ...
        'EditENUMITEM
        '
        Me.EditENUMITEM.AutoScroll = True
        Me.EditENUMITEM.Location = New System.Drawing.Point(8, 8)
        Me.EditENUMITEM.name = "EditENUMITEM"
        Me.EditENUMITEM.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditENUMITEM.TabIndex = 20
        Me.EditENUMITEM.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmENUMITEM
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditENUMITEM)
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.ENUMITEM)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditENUMITEM.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditENUMITEM_Changed() Handles EditENUMITEM.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditENUMITEM.GetMaxX() + 10, EditENUMITEM.GetMaxY() + 35)
