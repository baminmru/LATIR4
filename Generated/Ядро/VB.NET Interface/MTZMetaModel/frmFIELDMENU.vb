...
''' <summary>
'''Форма редактирования раздела Методы поля режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmFIELDMENU
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditFIELDMENU As MTZMetaModelGUI.editFIELDMENU
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditFIELDMENU = New MTZMetaModelGUI.EditFIELDMENU
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.FIELDMENU)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditFIELDMENU.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditFIELDMENU_Changed() Handles EditFIELDMENU.Changed
