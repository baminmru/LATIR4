...
''' <summary>
'''Форма редактирования раздела Разрешенные переходы режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmNEXTSTATE
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditNEXTSTATE As MTZMetaModelGUI.editNEXTSTATE
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditNEXTSTATE = New MTZMetaModelGUI.EditNEXTSTATE
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.NEXTSTATE)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditNEXTSTATE.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditNEXTSTATE_Changed() Handles EditNEXTSTATE.Changed
