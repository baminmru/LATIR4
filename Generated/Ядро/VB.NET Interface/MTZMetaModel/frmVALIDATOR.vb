...
''' <summary>
'''Форма редактирования раздела Логика на форме режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditVALIDATOR As MTZMetaModelGUI.editVALIDATOR
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditVALIDATOR = New MTZMetaModelGUI.EditVALIDATOR
        ...
        'EditVALIDATOR
        '
        Me.EditVALIDATOR.AutoScroll = True
        Me.EditVALIDATOR.Location = New System.Drawing.Point(8, 8)
        Me.EditVALIDATOR.name = "EditVALIDATOR"
        Me.EditVALIDATOR.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditVALIDATOR.TabIndex = 20
        Me.EditVALIDATOR.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmVALIDATOR
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditVALIDATOR)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmVALIDATOR"
        Me.Text = "Логика на форме"
...
#End Region
    Public Item As MTZMetaModel.MTZMetaModel.VALIDATOR
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.VALIDATOR)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditVALIDATOR.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditVALIDATOR_Changed() Handles EditVALIDATOR.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditVALIDATOR.GetMaxX() + 10, EditVALIDATOR.GetMaxY() + 35)
