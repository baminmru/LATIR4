...
''' <summary>
'''Форма редактирования раздела Методы раздела режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmPARTMENU
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditPARTMENU As MTZMetaModelGUI.editPARTMENU
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditPARTMENU = New MTZMetaModelGUI.EditPARTMENU
        ...
        'EditPARTMENU
        '
        Me.EditPARTMENU.AutoScroll = True
        Me.EditPARTMENU.Location = New System.Drawing.Point(8, 8)
        Me.EditPARTMENU.name = "EditPARTMENU"
        Me.EditPARTMENU.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditPARTMENU.TabIndex = 20
        Me.EditPARTMENU.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmPARTMENU
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditPARTMENU)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmPARTMENU"
        Me.Text = "Методы раздела"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.PARTMENU)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditPARTMENU.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditPARTMENU_Changed() Handles EditPARTMENU.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditPARTMENU.GetMaxX() + 10, EditPARTMENU.GetMaxY() + 35)
