...
''' <summary>
'''Форма редактирования раздела Контрольные элементы режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmGENCONTROLS
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditGENCONTROLS As MTZMetaModelGUI.editGENCONTROLS
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditGENCONTROLS = New MTZMetaModelGUI.EditGENCONTROLS
        ...
        'EditGENCONTROLS
        '
        Me.EditGENCONTROLS.AutoScroll = True
        Me.EditGENCONTROLS.Location = New System.Drawing.Point(8, 8)
        Me.EditGENCONTROLS.name = "EditGENCONTROLS"
        Me.EditGENCONTROLS.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditGENCONTROLS.TabIndex = 20
        Me.EditGENCONTROLS.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmGENCONTROLS
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditGENCONTROLS)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmGENCONTROLS"
        Me.Text = "Контрольные элементы"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.GENCONTROLS)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditGENCONTROLS.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditGENCONTROLS_Changed() Handles EditGENCONTROLS.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditGENCONTROLS.IsOK() Then
          EditGENCONTROLS.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditGENCONTROLS.GetMaxX() + 10, EditGENCONTROLS.GetMaxY() + 35)
