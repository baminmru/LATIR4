...
''' <summary>
'''Контрол редактирования раздела Динамический фильтр режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class editDINAMICFILTERSCRIPT
...
Me.lblTarget.Text = "Целевая платформа"
...
CType(Me.HolderPanel.ClientArea, Panel).Controls.Add(Me.txtCode)
        ...
        Me.name = "editDINAMICFILTERSCRIPT"
...
Public Sub Attach(ByVal gm As LATIR2GuiManager.LATIRGuiManager, ByVal ri As LATIR2.Document.DocRow_Base,byval RowReadOnly as boolean  ) Implements LATIR2GUIManager.IRowEditor.Attach
        Item = Ctype(ri,MTZMetaModel.MTZMetaModel.DINAMICFILTERSCRIPT)
        GuiManager = gm
