...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditFIELDPARAMMAP As MTZMetaModelGUI.editFIELDPARAMMAP
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditFIELDPARAMMAP = New MTZMetaModelGUI.EditFIELDPARAMMAP
        ...
        'EditFIELDPARAMMAP
        '
        Me.EditFIELDPARAMMAP.AutoScroll = True
        Me.EditFIELDPARAMMAP.Location = New System.Drawing.Point(8, 8)
        Me.EditFIELDPARAMMAP.name = "EditFIELDPARAMMAP"
        Me.EditFIELDPARAMMAP.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditFIELDPARAMMAP.TabIndex = 20
        Me.EditFIELDPARAMMAP.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmFIELDPARAMMAP
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditFIELDPARAMMAP)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmFIELDPARAMMAP"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.FIELDPARAMMAP)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditFIELDPARAMMAP.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditFIELDPARAMMAP_Changed() Handles EditFIELDPARAMMAP.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditFIELDPARAMMAP.IsOK() Then
          EditFIELDPARAMMAP.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditFIELDPARAMMAP.GetMaxX() + 10, EditFIELDPARAMMAP.GetMaxY() + 35)
