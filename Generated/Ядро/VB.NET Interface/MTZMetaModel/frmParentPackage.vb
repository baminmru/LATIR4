...
''' <summary>
'''Форма редактирования раздела Обязательные приложения режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmParentPackage
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditParentPackage As MTZMetaModelGUI.editParentPackage
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditParentPackage = New MTZMetaModelGUI.EditParentPackage
        ...
        'EditParentPackage
        '
        Me.EditParentPackage.AutoScroll = True
        Me.EditParentPackage.Location = New System.Drawing.Point(8, 8)
        Me.EditParentPackage.name = "EditParentPackage"
        Me.EditParentPackage.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditParentPackage.TabIndex = 20
        Me.EditParentPackage.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmParentPackage
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditParentPackage)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmParentPackage"
        Me.Text = "Обязательные приложения"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.ParentPackage)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditParentPackage.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditParentPackage_Changed() Handles EditParentPackage.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditParentPackage.IsOK() Then
          EditParentPackage.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditParentPackage.GetMaxX() + 10, EditParentPackage.GetMaxY() + 35)
