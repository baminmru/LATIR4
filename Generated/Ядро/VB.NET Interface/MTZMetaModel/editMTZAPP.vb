...
''' <summary>
'''Контрол редактирования раздела Приложение режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class editMTZAPP
...
Friend WithEvents txtDBName As LATIR2GuiManager.TouchTextBox
...
Me.txtDBName = New LATIR2GuiManager.TouchTextBox
...
Me.txtName.Text = "" 
Me.lblDBName.Location = New System.Drawing.Point(20,52)
Me.lblDBName.name = "lblDBName"
Me.lblDBName.Size = New System.Drawing.Size(200, 20)
Me.lblDBName.TabIndex = 3
Me.lblDBName.Text = "База данных"
Me.lblDBName.ForeColor = System.Drawing.Color.Blue
Me.txtDBName.Location = New System.Drawing.Point(20,74)
...
CType(Me.HolderPanel.ClientArea, Panel).Controls.Add(Me.lblDBName)
CType(Me.HolderPanel.ClientArea, Panel).Controls.Add(Me.txtDBName)
...
private sub txtDBName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDBName.TextChanged
  Changing
...
Public Sub Attach(ByVal gm As LATIR2GuiManager.LATIRGuiManager, ByVal ri As LATIR2.Document.DocRow_Base,byval RowReadOnly as boolean  ) Implements LATIR2GUIManager.IRowEditor.Attach
        Item = Ctype(ri,MTZMetaModel.MTZMetaModel.MTZAPP)
        GuiManager = gm
