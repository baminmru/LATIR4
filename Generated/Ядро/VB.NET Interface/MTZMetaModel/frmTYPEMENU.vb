...
''' <summary>
'''Форма редактирования раздела Методы типа режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTYPEMENU
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTYPEMENU As MTZMetaModelGUI.editTYPEMENU
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTYPEMENU = New MTZMetaModelGUI.EditTYPEMENU
        ...
        'EditTYPEMENU
        '
        Me.EditTYPEMENU.AutoScroll = True
        Me.EditTYPEMENU.Location = New System.Drawing.Point(8, 8)
        Me.EditTYPEMENU.name = "EditTYPEMENU"
        Me.EditTYPEMENU.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTYPEMENU.TabIndex = 20
        Me.EditTYPEMENU.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTYPEMENU
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTYPEMENU)
...
#End Region
    Public Item As MTZMetaModel.MTZMetaModel.TYPEMENU
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZMetaModel.MTZMetaModel.TYPEMENU)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTYPEMENU.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTYPEMENU_Changed() Handles EditTYPEMENU.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTYPEMENU.GetMaxX() + 10, EditTYPEMENU.GetMaxY() + 35)
