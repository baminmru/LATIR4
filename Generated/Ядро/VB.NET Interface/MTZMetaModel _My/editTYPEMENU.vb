...
''' <summary>
'''Контрол редактирования раздела Методы типа режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class editTYPEMENU
...
Me.lblIsToolBarButton.Text = "Включать в тулбар"
...
private sub cmbIsMenuItem_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbIsMenuItem.SelectedValueChanged
  on error resume next
  Changing

end sub
private sub cmbIsToolBarButton_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbIsToolBarButton.SelectedValueChanged
  on error resume next
  Changing
...
Public Sub Attach(ByVal gm As LATIR2GuiManager.LATIRGuiManager, ByVal ri As LATIR2.Document.DocRow_Base,byval RowReadOnly as boolean  ) Implements LATIR2GUIManager.IRowEditor.Attach
        Item = Ctype(ri,MTZMetaModel.MTZMetaModel.TYPEMENU)
        GuiManager = gm
