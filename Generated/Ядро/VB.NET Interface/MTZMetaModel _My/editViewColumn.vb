...
private sub cmbAggregation_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbAggregation.SelectedValueChanged
  on error resume next
  Changing
...
private sub cmbForCombo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbForCombo.SelectedValueChanged
  on error resume next
  Changing
...
if mIsOK then mIsOK =(cmbAggregation.SelectedIndex >=0)
        If mIsOK Then mIsOK = (cmbForCombo.SelectedValue >= 0)
        Return mIsOK
end function
