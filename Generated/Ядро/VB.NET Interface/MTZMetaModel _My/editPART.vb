...
private sub cmbPartType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbPartType.SelectedValueChanged
  on error resume next
  Changing
...
private sub cmbNoLog_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbNoLog.SelectedValueChanged
  on error resume next
  Changing

end sub
private sub cmbManualRegister_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbManualRegister.SelectedValueChanged
  on error resume next
  Changing
...
private sub cmbAddBehaivor_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbAddBehaivor.SelectedValueChanged
  on error resume next
  Changing
...
private sub cmbIsJormalChange_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbIsJormalChange.SelectedValueChanged
  on error resume next
  Changing
...
private sub cmbintegerpkey_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbintegerpkey.SelectedValueChanged
  on error resume next
  Changing
