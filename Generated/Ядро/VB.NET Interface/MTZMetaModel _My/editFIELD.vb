...
Dim OK as boolean 
    ...
    Private Sub cmbIsBrief_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbIsBrief.SelectedValueChanged
        On Error Resume Next
        Changing()

    End Sub
    Private Sub cmbIsTabBrief_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbIsTabBrief.SelectedValueChanged
        On Error Resume Next
        Changing()

    End Sub
    Private Sub cmbAllowNull_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbAllowNull.SelectedValueChanged
        On Error Resume Next
        Changing()
    ...
    End Sub
    Private Sub cmbReferenceType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbReferenceType.SelectedValueChanged
        On Error Resume Next
        Changing()
    ...
    End Sub
    Private Sub cmbInternalReference_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbInternalReference.SelectedValueChanged
        On Error Resume Next
        Changing()

    End Sub
    Private Sub cmbCreateRefOnly_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCreateRefOnly.SelectedValueChanged
        On Error Resume Next
        Changing()

    End Sub
    Private Sub cmbIsAutoNumber_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbIsAutoNumber.SelectedValueChanged
        On Error Resume Next
        Changing()
...
if mIsOK then mIsOK = not txtFieldType.Tag.Equals(System.Guid.Empty)
        If mIsOK Then mIsOK = (cmbIsBrief.SelectedValue >= 0)
        If mIsOK Then mIsOK = (cmbIsTabBrief.SelectedValue >= 0)
        If mIsOK Then mIsOK = (cmbAllowNull.SelectedValue >= 0)
        If mIsOK then mIsOK =(cmbReferenceType.SelectedIndex >=0)
        If mIsOK Then mIsOK = (cmbInternalReference.SelectedValue >= 0)
        If mIsOK Then mIsOK = (cmbCreateRefOnly.SelectedValue >= 0)
        If mIsOK Then mIsOK = (cmbIsAutoNumber.SelectedValue >= 0)
        Return mIsOK
end function
