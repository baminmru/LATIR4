...
''' <summary>
'''Реализация раздела Методы типав виде коллекции
''' </summary>
''' <remarks>
'''
''' </remarks>
    Public Class TYPEMENU_col
...
'''
''' </remarks>
        Public Function GetItem( vIndex as object ) As MTZMetaModel.TYPEMENU
            try
            GetItem = Convert.ChangeType(mybase.Item(vIndex), GetType(MTZMetaModel.TYPEMENU))
...
'''
''' </remarks>
        Public Shadows Function Item( vIndex as object ) As MTZMetaModel.TYPEMENU
          try
