...
'''
''' </remarks>
    Public Class FIELDPARAMMAP_col
...
'''
''' </remarks>
        Public Function GetItem( vIndex as object ) As MTZMetaModel.FIELDPARAMMAP
            try
            GetItem = Convert.ChangeType(mybase.Item(vIndex), GetType(MTZMetaModel.FIELDPARAMMAP))
...
'''
''' </remarks>
        Public Shadows Function Item( vIndex as object ) As MTZMetaModel.FIELDPARAMMAP
          try
...
Public Overrides Function FieldList() As String
    If mFieldList = "*" Then
       ...
       mFieldList=.ID2Base("FIELDPARAMMAPID")
