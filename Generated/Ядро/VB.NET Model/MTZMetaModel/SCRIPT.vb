...
''' <summary>
'''Реализация строки раздела Реализация
''' </summary>
''' <remarks>
'''
''' </remarks>
...
''' <summary>
'''Локальная переменная для поля Скрипт
''' </summary>
''' <remarks>
'''
''' </remarks>
...
''' <summary>
'''Локальная переменная для дочернего раздела Параметры
''' </summary>
''' <remarks>
'''
''' </remarks>
        private m_PARAMETERS As PARAMETERS_col
...
''' </remarks>
        Public Overrides Function FindInside(ByVal Table As String, ByVal RowID As String) As LATIR2.Document.DocRow_Base
            ...
            mFindInside = PARAMETERS.FindObject(table,RowID)
...
'''
''' </remarks>
        Public Property Target() As LATIR2.Document.docrow_base
            Get
                LoadFromDatabase()
                Target = me.application.Findrowobject("GENERATOR_TARGET",m_Target)
                AccessTime = Now
            End Get
...
''' <summary>
'''Доступ к дочернему разделу Параметры
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public readonly Property PARAMETERS() As PARAMETERS_col
            Get
                if  m_PARAMETERS is nothing then
                  m_PARAMETERS = new PARAMETERS_col
                  m_PARAMETERS.Parent = me
                  m_PARAMETERS.Application = me.Application
...
''' </remarks>
        Protected Overrides sub XMLUnpack(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
          ...
          try 
            ...
            e_list = node.SelectNodes("PARAMETERS_COL")
            PARAMETERS.XMLLoad(e_list,LoadMode)
             Changed = true
           catch ex as System.Exception
              Debug.Print( ex.Message + " >> " + ex.StackTrace)
          end try
