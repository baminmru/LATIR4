...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents ViewWorkPlace As MTZwpGUI.viewWorkPlacemain
   
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.tab = New System.Windows.Forms.TabControl
   TabPage1 = New System.Windows.Forms.TabPage
   ViewWorkPlace = new viewWorkPlacemain
   ...
   Me.TabPage1.SuspendLayout()
        ...
        'ViewWorkPlace
        '
        Me.ViewWorkPlace.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ViewWorkPlace.Location = New System.Drawing.Point(0, 0)
        Me.ViewWorkPlace.name = "ViewWorkPlace"
        Me.ViewWorkPlace.Size = New System.Drawing.Size(504, 352)
        Me.ViewWorkPlace.TabIndex = 0
...
''' </remarks>
    Public Sub Attach(ByVal docItem As LATIR2.Document.Doc_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, byval DocReadOnly as boolean  ) Implements LATIR2GUIManager.IViewPanel.Attach
        ...
        GuiManager = gm
        ViewWorkPlace.Attach(item, GuiManager,DocReadOnly)
    End Sub
...
''' </remarks>
    ...
    Dim ok As Boolean
    ok = True
        ok = ok And ViewWorkPlace.Save(Sielent, NoError)
       Return ok
    End function
...
''' </remarks>
    ...
    ok = False
        ok = ok or ViewWorkPlace.IsChanged()
       Return ok
    End function
