...
''' <summary>
'''Форма редактирования раздела Поведение журналов режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmARMJournalmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditARMJournal As MTZwpGUI.editARMJournalmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditARMJournal = New MTZwpGUI.EditARMJournalmain
        ...
        'EditARMJournal
        '
        Me.EditARMJournal.AutoScroll = True
        Me.EditARMJournal.Location = New System.Drawing.Point(8, 8)
        Me.EditARMJournal.name = "EditARMJournal"
        Me.EditARMJournal.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditARMJournal.TabIndex = 20
        Me.EditARMJournal.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmARMJournal
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditARMJournal)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmARMJournal"
        Me.Text = "Поведение журналов"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZwp.MTZwp.ARMJournal)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditARMJournal.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditARMJournal_Changed() Handles EditARMJournal.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditARMJournal.GetMaxX() + 10, EditARMJournal.GetMaxY() + 35)
