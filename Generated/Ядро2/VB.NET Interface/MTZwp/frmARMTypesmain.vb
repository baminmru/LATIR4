...
''' <summary>
'''Форма редактирования раздела Список типов режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmARMTypesmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditARMTypes As MTZwpGUI.editARMTypesmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditARMTypes = New MTZwpGUI.EditARMTypesmain
        ...
        'EditARMTypes
        '
        Me.EditARMTypes.AutoScroll = True
        Me.EditARMTypes.Location = New System.Drawing.Point(8, 8)
        Me.EditARMTypes.name = "EditARMTypes"
        Me.EditARMTypes.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditARMTypes.TabIndex = 20
        Me.EditARMTypes.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmARMTypes
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditARMTypes)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmARMTypes"
        Me.Text = "Список типов"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZwp.MTZwp.ARMTypes)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditARMTypes.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditARMTypes_Changed() Handles EditARMTypes.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditARMTypes.GetMaxX() + 10, EditARMTypes.GetMaxY() + 35)
