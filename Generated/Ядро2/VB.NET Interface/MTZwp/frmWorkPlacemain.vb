...
''' <summary>
'''Форма редактирования раздела Арм режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmWorkPlacemain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditWorkPlace As MTZwpGUI.editWorkPlacemain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditWorkPlace = New MTZwpGUI.EditWorkPlacemain
        ...
        'EditWorkPlace
        '
        Me.EditWorkPlace.AutoScroll = True
        Me.EditWorkPlace.Location = New System.Drawing.Point(8, 8)
        Me.EditWorkPlace.name = "EditWorkPlace"
        Me.EditWorkPlace.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditWorkPlace.TabIndex = 20
        Me.EditWorkPlace.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmWorkPlace
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditWorkPlace)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmWorkPlace"
        Me.Text = "Арм"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZwp.MTZwp.WorkPlace)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditWorkPlace.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditWorkPlace_Changed() Handles EditWorkPlace.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditWorkPlace.GetMaxX() + 10, EditWorkPlace.GetMaxY() + 35)
