...
''' <summary>
'''Форма редактирования раздела Меню режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmEntryPointsmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditEntryPoints As MTZwpGUI.editEntryPointsmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditEntryPoints = New MTZwpGUI.EditEntryPointsmain
        ...
        'EditEntryPoints
        '
        Me.EditEntryPoints.AutoScroll = True
        Me.EditEntryPoints.Location = New System.Drawing.Point(8, 8)
        Me.EditEntryPoints.name = "EditEntryPoints"
        Me.EditEntryPoints.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditEntryPoints.TabIndex = 20
        Me.EditEntryPoints.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmEntryPoints
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditEntryPoints)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmEntryPoints"
        Me.Text = "Меню"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZwp.MTZwp.EntryPoints)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditEntryPoints.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditEntryPoints_Changed() Handles EditEntryPoints.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditEntryPoints.IsOK() Then
          EditEntryPoints.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditEntryPoints.GetMaxX() + 10, EditEntryPoints.GetMaxY() + 35)
