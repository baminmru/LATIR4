...
''' <summary>
'''Контрол редактирования раздела Отчеты режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class editARMJRNLREPmain
...
Friend WithEvents txtTheReport As System.Windows.Forms.TextBox
...
Me.txtTheReport = New System.Windows.Forms.TextBox
