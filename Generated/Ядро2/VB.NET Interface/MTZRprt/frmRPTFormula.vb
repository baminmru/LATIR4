...
''' <summary>
'''Форма редактирования раздела Формулы режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmRPTFormula
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditRPTFormula As MTZRprtGUI.editRPTFormula
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditRPTFormula = New MTZRprtGUI.EditRPTFormula
        ...
        'EditRPTFormula
        '
        Me.EditRPTFormula.AutoScroll = True
        Me.EditRPTFormula.Location = New System.Drawing.Point(8, 8)
        Me.EditRPTFormula.name = "EditRPTFormula"
        Me.EditRPTFormula.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditRPTFormula.TabIndex = 20
        Me.EditRPTFormula.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmRPTFormula
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditRPTFormula)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmRPTFormula"
        Me.Text = "Формулы"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZRprt.MTZRprt.RPTFormula)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditRPTFormula.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditRPTFormula_Changed() Handles EditRPTFormula.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditRPTFormula.GetMaxX() + 10, EditRPTFormula.GetMaxY() + 35)
