...
''' <summary>
'''Форма редактирования раздела Секции режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmRPTStruct
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditRPTStruct As MTZRprtGUI.editRPTStruct
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditRPTStruct = New MTZRprtGUI.EditRPTStruct
        ...
        'EditRPTStruct
        '
        Me.EditRPTStruct.AutoScroll = True
        Me.EditRPTStruct.Location = New System.Drawing.Point(8, 8)
        Me.EditRPTStruct.name = "EditRPTStruct"
        Me.EditRPTStruct.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditRPTStruct.TabIndex = 20
        Me.EditRPTStruct.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmRPTStruct
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditRPTStruct)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmRPTStruct"
        Me.Text = "Секции"
...
#End Region
    Public Item As MTZRprt.MTZRprt.RPTStruct
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZRprt.MTZRprt.RPTStruct)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditRPTStruct.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditRPTStruct_Changed() Handles EditRPTStruct.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditRPTStruct.GetMaxX() + 10, EditRPTStruct.GetMaxY() + 35)
