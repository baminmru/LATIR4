...
''' <summary>
'''Форма редактирования раздела Реализации расширения режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmMTZExtRel
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditMTZExtRel As MTZExtGUI.editMTZExtRel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditMTZExtRel = New MTZExtGUI.EditMTZExtRel
        ...
        'EditMTZExtRel
        '
        Me.EditMTZExtRel.AutoScroll = True
        Me.EditMTZExtRel.Location = New System.Drawing.Point(8, 8)
        Me.EditMTZExtRel.name = "EditMTZExtRel"
        Me.EditMTZExtRel.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditMTZExtRel.TabIndex = 20
        Me.EditMTZExtRel.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmMTZExtRel
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditMTZExtRel)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmMTZExtRel"
        Me.Text = "Реализации расширения"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZExt.MTZExt.MTZExtRel)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditMTZExtRel.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditMTZExtRel_Changed() Handles EditMTZExtRel.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditMTZExtRel.GetMaxX() + 10, EditMTZExtRel.GetMaxY() + 35)
