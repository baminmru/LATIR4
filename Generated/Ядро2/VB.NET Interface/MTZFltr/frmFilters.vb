...
''' <summary>
'''Форма редактирования раздела Фильтр режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditFilters As MTZFltrGUI.editFilters
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditFilters = New MTZFltrGUI.EditFilters
        ...
        'EditFilters
        '
        Me.EditFilters.AutoScroll = True
        Me.EditFilters.Location = New System.Drawing.Point(8, 8)
        Me.EditFilters.name = "EditFilters"
        Me.EditFilters.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditFilters.TabIndex = 20
        Me.EditFilters.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmFilters
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditFilters)
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZFltr.MTZFltr.Filters)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditFilters.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditFilters_Changed() Handles EditFilters.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditFilters.GetMaxX() + 10, EditFilters.GetMaxY() + 35)
