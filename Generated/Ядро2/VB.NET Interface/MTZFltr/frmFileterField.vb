...
''' <summary>
'''Форма редактирования раздела Поле фильтра режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmFileterField
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditFileterField As MTZFltrGUI.editFileterField
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditFileterField = New MTZFltrGUI.EditFileterField
        ...
        'EditFileterField
        '
        Me.EditFileterField.AutoScroll = True
        Me.EditFileterField.Location = New System.Drawing.Point(8, 8)
        Me.EditFileterField.name = "EditFileterField"
        Me.EditFileterField.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditFileterField.TabIndex = 20
        Me.EditFileterField.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmFileterField
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditFileterField)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmFileterField"
        Me.Text = "Поле фильтра"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, MTZFltr.MTZFltr.FileterField)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditFileterField.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditFileterField_Changed() Handles EditFileterField.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditFileterField.IsOK() Then
          EditFileterField.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditFileterField.GetMaxX() + 10, EditFileterField.GetMaxY() + 35)
